...
if __name__=="__main__":
    ...
    weight_best_path = os.path.join(H5_PATH, "coronary_weightsC." + LOG_NAME + ".0_12_r.best." + k_fold_idx + ".hdf5")
    weight_warm_path = os.path.join(H5_PATH, "coronary_weightsC." + LOG_NAME + ".0_12_r.warm." + k_fold_idx + ".hdf5")
    weight_final_path = os.path.join(H5_PATH, "full_coronary_modelC." + LOG_NAME + ".0_12_r." + k_fold_idx + ".hdf5")
    ...
    train_df[['level']].hist(figsize=(10, 3))
    #show()
